...
from SERVER.EnvNetwork import Environment
M_IN_K = 1000.0
...
class ABREnv:
    ...
    Note: trace JSON doesn't include video segment sizes or bitrates ladder
    """
    ...
    def __init__(
        ...
        print('VIDEO BITRATES:', self.video_bitrates, ' from ', video_path)
        if self.a_dim <= 0:
