# --plugin algo/fastmpc.py -a fastmpc -n 4Glogs_lum\4g_trace_driving_50015_dr.json -m movie_4g.json --shim 8391 
# fastmpc.py
...
@register_abr("fastmpc")
class FastMpcAbr(HttpShimBase):
    SHIM_NAME = "fastmpc"
