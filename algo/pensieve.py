#python sab.py --verbose --debug_p --plugin algo/pensieve.py -a pensieve -n 4Glogs_lum\4g_trace_driving_50015_dr.json -m movie_4g.json --shim 8605
...
@register_abr("pensieve")
class Pensieve(HttpShimBase):
    SHIM_NAME = "pensieve"
